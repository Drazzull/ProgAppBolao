 ...
 * @author José Luiz
 */
@WebServlet(name = "ReportRankingGrupo", urlPatterns =
{
    "/ReportRankingGrupo"
})
public class ReportRankingGrupo extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        try
        {
            ...
            File reportFile = new File(request.getServletContext().getRealPath("/WEB-INF/reportRankingGrupo.jasper"));

            //Definindo mapa de parâmetros que serão enviados ao jasper...
            Map parameters = new HashMap();
            String titulo = "Ranking por grupo - ";
            ...
            List<RankingObj> rankings = rankingDAO.listarPorGrupo(competicao);
