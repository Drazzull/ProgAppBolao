...
public class ConectaMySQL {
        public static void main(String[] args) throws ParseException {
            ...
            data_nasc = null;
             ...
             data_ini = sdf.parse("2014-01-15");
             data_fim = sdf.parse("2014-12-10");
             Competicao com1 = new Competicao("Campeonato Brasileiro 2014", data_ini, data_fim);
             competicoes.add(com1);
             data_ini = null;
             data_fim = null;
             
             data_ini = sdf.parse("2014-05-14");
             data_fim = sdf.parse("2014-12-01");
             Competicao com2 = new Competicao("Copa do Brasil 2014", data_ini, data_fim);
             competicoes.add(com2);
             data_ini = null;
             data_fim = null;
             
             for(Competicao c : competicoes)
                 competicaoDAO.salvar(c);
            ...
            Ranking ranking1 = new Ranking(rod3, madara, new Long(250));
            rankings.add(ranking1);
            Ranking ranking2 = new Ranking(rod3, boruto, new Long(420));
            rankings.add(ranking2);
            Ranking ranking3 = new Ranking(rod3, van, new Long(710));
            rankings.add(ranking3);
            Ranking ranking4 = new Ranking(rod2, boruto, new Long(150));
            rankings.add(ranking4);
            Ranking ranking5 = new Ranking(rod3, madara, new Long(650));
            rankings.add(ranking5);
            
            for(Ranking ra : rankings)
                rankingDAO.salvar(ra);
            
            System.out.println("Apostadores");
            for(RankingObj ra_obj : rankingDAO.listarPorApostador(com1))
                System.out.println("Posição: "+ra_obj.getPosicao()+" Nome: "+ra_obj.getNome()+" Apelido: "+ra_obj.getApelido()+" Pontuação: "+ra_obj.getPontuacao());
            
            for(RankingObj ra_obj : rankingDAO.listarPorGrupo(com1))
